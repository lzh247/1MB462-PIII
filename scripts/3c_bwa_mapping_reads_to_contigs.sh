...
bwa mem -t 12 $CONTIGDIR/D1_megahit_output/final.contigs.fa $READDIR/SRR4342129_1.paired.trimmed.fastq.gz $READDIR/SRR4342129_2.paired.trimmed.fastq.gz 2> $OUTDIR/D1/D1.bam.bwa.log | samtools sort -o $OUTDIR/D1/D1.sorted.bam
# Create depth file
...
bwa mem -t 12 $CONTIGDIR/D3_megahit_output/final.contigs.fa $READDIR/SRR4342133_1.paired.trimmed.fastq.gz $READDIR/SRR4342133_2.paired.trimmed.fastq.gz 2> $OUTDIR/D3/D3.bam.bwa.log | samtools sort -o $OUTDIR/D3/D3.sorted.bam
# Create depth file
